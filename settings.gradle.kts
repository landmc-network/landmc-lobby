...
plugins {
    // Provisions a JDK 25 when the machine does not have one; Paper 26.2 and the platform's
    // paper module both publish Java 25 bytecode.
    ...
    repositories {
        ...
        if (githubUser != null && githubToken != null) {
            maven("https://maven.pkg.github.com/landmc-network/landmc-platform") {
                ...
                // and the menu wire format is published from a different repository.
                content { includeModuleByRegex("pl\\.landmc", "platform-.*") }
            }

            // The wire format the hotbar asks the proxy to open a menu with.
        ...
        maven("https://repo.papermc.io/repository/maven-public/") {
            content {
                ...
                // Paper's own transitive dependencies live here, not on Central.
